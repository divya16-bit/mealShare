...
import '../styles/RegisterPageFC.css'; // Create a new CSS file for this page

function RegisterPageFC() {
  return (
    <div className="register-page">
      ...
      <div className="register-container">
        <div className="register-box">
          <h2>Create your account as Food Consumer</h2>
          <form>
